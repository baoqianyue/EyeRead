...
data class Item(val type: String, val data: Data?, val tag: String) : Serializable {
    ...
    data class Data(val dataType: String, val text: String, val videoTitle: String, val id: Long,
        ...
        data class Tag(val id: Int, val name: String, val actionUrl: String,
        ...
        data class User(val uid: Long, val nickname: String, val avatar: String,
                        val userType: String, val ifPgc: Boolean) : Serializable
